...
import 'package:yesorno/genel_screens/genel_result.dart';

import 'genel_question_model.dart';

class GenelQuestionPage extends StatefulWidget {
  final List<QuestionResult> _questions =
      QuestionResult.getRandomDefaultQuestionsShuffled();

  GenelQuestionPage({super.key});

  @override
  State<StatefulWidget> createState() {
    return _GenelQuestionPageState();
  }
}

class _GenelQuestionPageState extends State<GenelQuestionPage> {
  //in ms
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
              image: const AssetImage('assets/images/genel.jpeg'),
  ...
  void _showResult(int correctAnswers) {
    Navigator.of(context).pushReplacement(MaterialPageRoute(
        builder: (context) => GenelResultPage(
